...
from .views import home, room, criarRoom, editarRoom, deletarRoom, loginPag, logoutUsuario, registrarUsuario, deletarMensagem, perfilUser, criarTopico
...
urlpatterns = [
    ...
    path('novo-topico/', criarTopico, name='criar-topico' ),
    ]
